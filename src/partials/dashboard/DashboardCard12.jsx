        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              <div className="w-9 h-9 rounded-full shrink-0 bg-primary my-2 mr-3">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  ...
                  <div className="shrink-0 self-end ml-2">
                    <a className="font-medium text-primary hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
              </div>
            </li>
